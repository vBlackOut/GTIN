...
if "__main__" == __name__:
    ...
    list_barcode = gtin.generator_barcode(barcode_lenght=[8,12,13,14,17,18], number_barcode=10, status_barcode=None) # return generate test 10 barcode, return just barcode of status True barcode of lenght variable 8-18
